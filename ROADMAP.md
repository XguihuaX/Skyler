...
| **v3-F'：主动对话 + 时间感知（饭点 / 睡前 / 长时无互动）** | 🟡 engine + 哲学（模式 A / B）已就位（v3-G chunk 2 / 2.6），剩余工作 = 写 N 个 trigger 配置 + 各自 prompt 模板 | 30% |
| v3-G：生活 & 工具型能力（剪贴板 / 简报 / cron / 成长系统） | 🚧 chunk 0 ✅ + 1 ✅ + 1.5 ✅ + 1.6 ✅ + 1.7 ✅ + 2 ✅ 智能简报 + proactive engine + 2.6 ✅ wake_call 邀请对话模式（2026-05-08） | 85% |
