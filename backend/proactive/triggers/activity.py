...
# INV-13 Option G(2026-05-27)软化:原 "40-80 字 硬要求" 改为 "适度长度 ·
# 1-2 句"。详 docs/INV-13-*.md §11.5 / §12.6 — Layer A ja directive ≥10字意群
# 跟硬字数撞车导致 LLM 偶发 thinking debate。
_BASE_GUIDANCE = """这是一次**活动感知主动开口**：你注意到了用户活动的变化，想轻巧地搭个话。

⚠️ 本轮风格要求:
- **适度长度 · 1-2 句**(参考 40-80 字 · 软指引非硬约束)。不要长篇大论,不要列表分点。
